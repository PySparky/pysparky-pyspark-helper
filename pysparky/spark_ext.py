...
def convert_dict_to_dataframev2(self, _dict: dict[str, Any], column_names: list[str], explode: bool = False) -> pyspark.sql.DataFrame:
    """
    Converts a dictionary with list values into a Spark DataFrame.
    ...
    output_sdf = self.createDataFrame(_dict.items(), column_names)
